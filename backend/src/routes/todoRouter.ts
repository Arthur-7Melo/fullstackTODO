...
import { createTodoHandler, deleteTodoHandler, getUserTodos, updateTodoHandler } from "../controllers/todoController";
...
router.delete("/:id", authorizeTodos, deleteTodoHandler);
